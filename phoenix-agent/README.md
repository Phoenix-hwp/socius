...
> v0.3 | 2026-05-21 | D:\Phoenix\cursor-knowledge\phoenix-agent
...
# 恢复机制 15 项测试
python phoenix-agent/src/p008/test_recovery.py

# 集成测试 4 组
python phoenix-agent/src/p008/test_integration.py

# 安全闸门 65 项测试（含 1 项已知编码差异）
python phoenix-agent/src/p008/test_safety_gate.py
```
...
配置文件位于 `.cursor/` 而不是 `phoenix-agent/` 内：
