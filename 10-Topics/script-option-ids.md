...
**说明**：跨设备与工作区版本同步统一走 **Git**；口语 **`提交git`** 见 `.cursor/rules/git-workspace-commit.mdc` 与 **`10-Topics/Gitee-Workspace-Git-Workflow.md`**。

| 选项 ID | 说明 |
|---------|------|
| `git.workspace.workflow` | 备忘路径：`10-Topics/Gitee-Workspace-Git-Workflow.md`（首次 `remote`、日常 `commit`/`push`） |
| `git.workspace.rule` | 执行级规则：`.cursor/rules/git-workspace-commit.mdc` |
...
- Git 工作流变更时，同步更新 **`10-Topics/Gitee-Workspace-Git-Workflow.md`** 与本表 **`git.workspace.*`** 说明。
